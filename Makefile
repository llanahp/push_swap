...
SRCS = libft/ft_isalpha.c libft/ft_isalnum.c libft/ft_isascii.c libft/ft_isprint.c \
        ...
        libft/ft_split_clear.c libft/ft_strcmp.c\
		ft_validate_input.c ft_lstaux.c ft_push.c ft_reverse_rotate.c ft_rotate.c \
        ft_swap.c ft_validation.c ft_small_sort.c ft_big_sort.c push_swap.c  \
